...
from dcgan_pytorch.models.discriminator import discriminator_for_imagenet
from dcgan_pytorch.utils.common import AverageMeter
from dcgan_pytorch.utils.common import ProgressMeter
from dcgan_pytorch.utils.common import configure
from dcgan_pytorch.utils.common import create_folder
...
parser.add_argument("-a", "--arch", metavar="ARCH", default="dcgan",
                    choices=model_names,
...
parser.add_argument("--image-size", type=int, default=64,
                    help="Image size of high resolution image. (Default: 64)")
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    discriminator = discriminator_for_imagenet()
